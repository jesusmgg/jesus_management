"""
Django settings for jesus_management project.
...
SECRET_KEY = '9pgy_)&c*g4yacr92=wp^(@u#@1+1uw(m5ebj=l^_iv$4qth0i'
...
ROOT_URLCONF = 'jesus_management.urls'
...
WSGI_APPLICATION = 'jesus_management.wsgi.application'
